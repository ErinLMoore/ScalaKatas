...
class berlinclockSpec extends FlatSpec with Matchers {
  val berliner = Main
    ...
    "Berliner" should "return the correct single hours row" in {
      berliner.single_hours_row(0) shouldBe 0
      berliner.single_hours_row(2) shouldBe 2
      berliner.single_hours_row(3) shouldBe 3
      berliner.single_hours_row(5) shouldBe 5
    }

    "Berliner" should "return the correct single hours row" in {
      berliner.five_hours_row(0) shouldBe 0
      berliner.five_hours_row(2) shouldBe 0
      berliner.five_hours_row(3) shouldBe 0
      berliner.five_hours_row(5) shouldBe 1
    }
